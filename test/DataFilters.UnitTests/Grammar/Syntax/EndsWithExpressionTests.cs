...
public class EndsWithExpressionTests(ITestOutputHelper outputHelper)
{
    ...
    {
        // Act
        Action action = () => _ = new EndsWithExpression((string)null);
    ...
    {
        // Act
        Action action = () => _ = new EndsWithExpression((TextExpression)null);
    ...
    {
        // Act
        Action action = () => _ = new EndsWithExpression(string.Empty);
