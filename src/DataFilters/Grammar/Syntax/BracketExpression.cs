...
public sealed class BracketExpression(params BracketValue[] values) : FilterExpression, IEquatable<BracketExpression>
{
    ...
    /// </summary>
    public IEnumerable<BracketValue> Values { get; } = [.. values.Where(value => value is not null)];
