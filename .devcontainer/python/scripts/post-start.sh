...
log_info "================================================"
log_info "DataFilters (Python) DevContainer Post-Start Setup"
log_info "================================================"
...
log_info "Ensuring Python development dependencies are up to date..."
cd src/python
pip install -e ".[dev]" -q
cd ../..
...
log_info "========================================"
log_info ""
log_info "Run Python tests:"
log_info "  cd src/python && pytest tests/"
log_info ""
log_info "Run linter:"
log_info "  cd src/python && flake8 datafilters tests"
log_info ""
